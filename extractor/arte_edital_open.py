...
def construir_prompt_extracao_itens(texto_pdf):
    ...
    O arquivo fornecido pode estar embaralhado, com quebras de linha e formatação inconsistente.
    Entenda o contexto total como um todo e busque encaixar as peças de informação.
