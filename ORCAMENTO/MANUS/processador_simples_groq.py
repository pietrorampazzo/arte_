...
MODELO = "allam-2-7b"  # Modelo mais estável

# Parâmetros
BATCH_SIZE = 500  # Começar pequeno para garantir funcionamento
...
def main():
    ...
    try:
        ...
        df_produtos = df_produtos.dropna(subset=['DESCRICAO'])
        df_produtos = df_produtos[df_produtos['DESCRICAO'].astype(str).str.strip() != '']
