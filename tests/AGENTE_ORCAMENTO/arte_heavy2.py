...
# --- File Paths ---
CAMINHO_EDITAL = r"C:\Users\pietr\Downloads\TESTE 2.xlsx"
CAMINHO_BASE = r'C:\Users\pietr\OneDrive\.vscode\arte_\DOWNLOADS\RESULTADO_metadados\categoria_o4-mini_v4.xlsx'
CAMINHO_SAIDA = "sheets/RESULTADO_proposta/master_25.xlsx"
...
def main():
    ...
    # A inicialização do modelo agora é feita dentro da função de fallback
    ...
    for idx, item_edital in df_edital.iterrows():
        ...
        valor_unit_edital = float(item_edital.get('VALOR_UNIT', 0))
