...
<formato_saida>
| UNID_FORN | QTDE | VALOR_TOTAL | LOCAL_ENTREGA | INTERVALO_LANCES | Marca Sugerida | Modelo Sugerido | Preço Fornecedor | Preço com Margem 53% | % Compatibilidade |
</formato_saida>
"""
        ...
        if len(linhas) > 0:
            ...
            if len(colunas) >= 10:
                ...
                resultados.append({
                    ...
                    'INTERVALO_LANCES': intervalo_lances, # Este já estava aqui, mas o prompt não pedia
                    'Marca Sugerida': colunas[5],
                    'Modelo Sugerido': colunas[6],
                    'Preço Fornecedor': colunas[7],
                    'Preço com Margem 53%': colunas[8],
                    '% Compatibilidade': colunas[9]
                })
