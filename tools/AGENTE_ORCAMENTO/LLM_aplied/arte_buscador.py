...
# -*- coding: utf-8 -*-
"""
🎼 BUSCADOR MUSICAL OTIMIZADO
Versão: Estado da Arte - Agosto 2025
Autor: Arte Comercial Ltda.

FUNCIONALIDADES:
✅ Matching hierárquico com embeddings FAISS
...
from versoes.AGENTE_ORCAMENTO.LLM_aplied.api_google import GOOGLE_API_KEY
...
def processar_edital(caminho_edital, matcher):
    ...
    for _, row in tqdm(df_edital.iterrows(), total=len(df_edital), desc="Processando edital"):
        ...
        if candidatos:
            ...
            qualidade, emoji = matcher.determine_qualidade(melhor['score_final'])
