...
def test_scripts():
    ...
    scripts_to_test = [
        ...
        (os.path.join(scripts_dir, "DOWNLOAD", "arte_orquestra.py"), "Download de editais"),
        (os.path.join(scripts_dir, "METADADOS", "arte_metadados.py"), "Processamento de metadados"),
        (os.path.join(scripts_dir, "ORCAMENTO", "arte_heavy.py"), "Matching de produtos"),
    ]
